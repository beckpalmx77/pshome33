                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="control-label">ทะเบียนรถ 8</label>
                                                                <input type="text" class="form-control" id="car_no8">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="control-label">จังหวัด</label>
                                                                <input type="text" class="form-control" id="car_no8_province">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="control-label">ยี่ห้อ-รุ่น</label>
                                                                <input type="text" class="form-control" id="car_no8_brand">                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="control-label">สี</label>
                                                                <input type="text" class="form-control" id="car_no8_color">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="control-label">ประเภท</label>
                                                                <select class="form-control" id="car_no8_type">
                                                                    <option value="">-- เลือก --</option>
                                                                    <option value="รถยนต์">รถยนต์</option>
                                                                    <option value="จักรยานยนต์">จักรยานยนต์</option>
                                                                </select>
    ...
    <script>
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response && response.length > 0) {
                            ...
                            $('#car_no8').val(house.car_no8 || '');
                            $('#car_no8_province').val(house.car_no8_province || '');
                            $('#car_no8_brand').val(house.car_no8_brand || '');
                            $('#car_no8_color').val(house.car_no8_color || '');
                            $('#car_no8_type').val(house.car_no8_type || '');
            ...
            $("#btnSave").click(function () {
                ...
                let car_no8 = $('#car_no8').val().trim();
                let car_no8_province = $('#car_no8_province').val().trim();
                let car_no8_brand = $('#car_no8_brand').val().trim();
                let car_no8_color = $('#car_no8_color').val().trim();
                let car_no8_type = $('#car_no8_type').val().trim();
            ...
            $('#car_no1, #car_no2, #car_no3, #car_no4, #car_no5, #car_no6, #car_no7, #car_no8').on('input', updateCarCount);
