                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <a href="report_common_fee_estimate.php?m=<?php echo isset($_GET['m']) ? urlencode($_GET['m']) : urlencode('รายงานต่าง ๆ'); ?>&s=<?php echo urlencode('เปรียบเทียบประมาณการและยอดจัดเก็บค่าส่วนกลาง'); ?>" class="btn btn-sm btn-outline-primary ml-2">
