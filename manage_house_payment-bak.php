...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // กำหนด locale เป็น 'th' สำหรับภาษาไทย
            let initialLocaleCode = 'th';

            let calendar = new FullCalendar.Calendar(calendarEl, {
                timeZone: 'local',
                headerToolbar: {
                    // เพิ่ม 'multiMonth' เข้าไปในส่วนซ้าย
                    right: 'prev,next today',
                    center: 'title',
                    left: 'multiMonth,dayGridMonth' // แสดงปุ่ม Multi-Month และ Month
                },
                buttonText: {
                    today: 'วันนี้',
                    month: 'เดือน',
                    multiMonth: 'หลายเดือน', // ข้อความสำหรับปุ่ม Multi-Month
                    week: 'สัปดาห์',
                    day: 'วัน',
                },
                // ใช้ภาษาไทย
                locale: initialLocaleCode,
                // กำหนดมุมมองเริ่มต้นเป็น Multi-Month
                initialView: 'multiMonth',
                // ตั้งค่าความสูงเป็น 'auto' เพื่อให้ปฏิทินยืดหยุ่นตามจำนวนเดือน
                height: 'auto',
                // ** ตัวเลือกเสริม: จำกัดจำนวนคอลัมน์ของเดือน (สำหรับ multiMonth)**
