...
if (strlen($_SESSION['alogin']) == "") {
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="config_id" class="control-label">config id</label>
                                                                    <input type="config_id" class="form-control"
                                                                           id="config_id" name="config_id"
                                                                           readonly="true"
    ...
    <script>
        ...
        $("#description").blur(function () {
            ...
            if (method === "ADD") {
                ...
                let formData = {action: "SEARCH", config_id: config_id, description: description};
                $.ajax({
                    url: 'model/manage_config_process.php',
                    method: "POST",
                    data: formData,
    ...
    <script>
        $(document).ready(function () {
            let formData = {action: "GET_CONFIG", sub_action: "GET_MASTER"};
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < len; i++) {
                        ...
                        let config_id = response[i].config_id;
