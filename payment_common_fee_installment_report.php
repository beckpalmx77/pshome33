                                    ...
                                    <form id="form_data" method="post"
                                          enctype="multipart/form-data" target="_blank"> <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <button type="submit" class="btn btn-primary" id="btnPrintDownPaymentPdf">
                                                            สรุปค่าทำสัญญา PDF <i class="fa fa-file-pdf"></i>
                                                        </button>
                                                        <button type="submit" class="btn btn-primary" id="btnPrintPdf">
                                                            สรุปการผ่อนชำระ PDF <i class="fa fa-file-pdf"></i>
                                                        </button>
                                                    </div>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnPrintPdf').on('click', function(e) {
                ...
                $('#form_data').attr('action', 'export_process/payment_common_fee_installment_report_pdf');
                $('#form_data').submit();
            });
            ...
            $('#btnPrintDownPaymentPdf').on('click', function(e) {
                e.preventDefault(); // หยุดการ submit ฟอร์มตามปกติ
                $('#form_data').attr('action', 'export_process/payment_common_fee_downpayment_report_pdf');
                $('#form_data').submit();
            });
        });
    </script>
