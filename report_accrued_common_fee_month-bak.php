                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">กรุณาเลือกเดือนและปีที่ต้องการตรวจสอบ</h6>
                                </div>
                                <div class="card-body">
                                    <form action="" method="GET" class="row g-3 align-items-end mb-4">
                                        ...
                                        <div class="col-md-2">
                                            <a href="?m=<?= urlencode($_GET['m'] ?? '') ?>&s=<?= urlencode($_GET['s'] ?? '') ?>" class="btn btn-outline-secondary w-100"><i class="bi bi-arrow-clockwise"></i> เดือนปัจจุบัน</a>
                                        </div>
                                    </form>
                                    ...
                                    <div class="mt-4">
                                        <h5><i class="bi bi-file-earmark-text-fill"></i> ผลการค้นหา: บ้านที่ค้างชำระประจำเดือน <strong><?= htmlspecialchars($display_month_name) ?></strong> ปี <strong><?= $selected_year + 543 ?></strong></h5>
            ...
            $('#reportTable').DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        title: 'รายงานบ้านที่ค้างชำระ ประจำเดือน <?= $display_month_name ?> ปี <?= $selected_year + 543 ?>',
                        customize: function (doc) {
                            doc.defaultStyle.font = 'Sarabun';
                            doc.styles.tableHeader.alignment = 'center';
                            doc.content[1].table.widths = ['15%','30%','35%','20%'];
                        }
                    }
                ]
            });
