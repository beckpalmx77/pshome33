    ...
    foreach ($empRecords as $row) {
        if ($isMaster) {
            ...
            $data[] = [
                ...
                "update" => $isUser ? "<button type='button' class='btn btn-info btn-xs update' disabled>Detail</button>"
                    : "<button type='button' name='update' id='{$row['id']}' class='btn btn-info btn-xs update'>Detail</button>",
