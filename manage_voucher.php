        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                                ...
                                <div class="card-body">
                                    <section class="container-fluid">
                                        ...
                                        <div class="col-md-12 col-md-offset-2">
                                            ...
                                            <a href="expense_user_manaul.html" target="_blank" class="btn btn-info btn-xs" data-toggle="tooltip" title="คู่มือการใช้งาน บันทึกใบสำคัญจ่าย / บันทึกค่าใช้จ่าย">
                                                <i class="fa fa-book"></i> คู่มือการใช้งาน บันทึกใบสำคัญจ่าย / บันทึกค่าใช้จ่าย
                                            </a>
                    ...
                    <div class="modal fade" id="voucherSummaryModal" tabindex="-1" role="dialog"
                         aria-labelledby="voucherSummaryLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title" id="voucherSummaryLabel">สรุปยอดจ่าย (Voucher) รายเดือน</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btnSummary').on('click', function () {
                ...
                $('#voucherSummaryModal').modal('show');
            });
